...
public class AstahFileToHash
{
     ...
     *            プロジェクトファイル名
     * @throws Exception
     *             Astah pluginが発行する例外は一旦catchし、内容をStringに格納してExceptionとしてthrowする
     * @throws IOException
     *             内部で発生してもcatchしない
     ...
     *
     */
    AstahFileToHash( String projectFilename ) throws Exception, IOException, ClassNotFoundException {
        try {
