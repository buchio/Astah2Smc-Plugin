...
public class AstahProjectToHash
{
    ...
    private HashMap getPackageInfo(IPackage iPackage ) throws Exception, InvalidUsingException {
        HashMap<String, HashMap> stateMachines = new HashMap<String, HashMap>();
    ...
    private HashMap getDiagramInfo(IDiagram iDiagram) throws Exception {
