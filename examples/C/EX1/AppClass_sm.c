...
static void Map1_Start_Unknown(struct AppClassContext *fsm)
{
    ...
    EXIT_STATE(getState(fsm));
    if (getDebugFlag(fsm) != 0) {
        TRACE("ENTER TRANSITION: Map1_&Map1_Start.Unknown()\n");
    }
    if (getDebugFlag(fsm) != 0) {
        TRACE("EXIT TRANSITION : Map1_&Map1_Start.Unknown()\n");
    }
...
static void Map1_Zeros_Unknown(struct AppClassContext *fsm)
{
    ...
    EXIT_STATE(getState(fsm));
    if (getDebugFlag(fsm) != 0) {
        TRACE("ENTER TRANSITION: Map1_&Map1_Zeros.Unknown()\n");
    }
    if (getDebugFlag(fsm) != 0) {
        TRACE("EXIT TRANSITION : Map1_&Map1_Zeros.Unknown()\n");
    }
    setState(fsm, &Map1_Error);
    ENTRY_STATE(getState(fsm));
}
...
static void Map1_Ones_Unknown(struct AppClassContext *fsm)
{
    ...
    EXIT_STATE(getState(fsm));
    if (getDebugFlag(fsm) != 0) {
        TRACE("ENTER TRANSITION: Map1_&Map1_Ones.Unknown()\n");
    }
    if (getDebugFlag(fsm) != 0) {
        TRACE("EXIT TRANSITION : Map1_&Map1_Ones.Unknown()\n");
    }
    setState(fsm, &Map1_Error);
    ENTRY_STATE(getState(fsm));
}
